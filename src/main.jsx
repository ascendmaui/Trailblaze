...
function PortalStrip() { return <section className="demo-strip wrap"><div><span>OPERATIONS PORTAL</span><h2>Website plus operating portal in one walkthrough.</h2><p>Sign in to manage the owner dashboard, employee field view, jobs, payouts, team, notifications, and settings.</p></div><button className="btn btn-dark" onClick={() => go('/login')}>OPEN PORTAL <Icon name="arrow" size={16} /></button></section>; }
